...
<body>
<h1><u>Задание к уроку №2.1</u><h1>
<p> Составить рекурсивную функцию вычисления чисел Фибоначчи, проверьте ее работу </p>

<?php
function fibo($n){
	if ($n<=2)    //Fibot F(2)=1 , F(1)=1, F(0)=0;   F(3) = 2
		return 1;
	else 
		return (fibo($n-1)+fibo($n-2));
}	
$n=10;  //F(10)=55
 echo 'Число Фибоначчи' . ' (для $n = ' . $n . ') = '  . fibo($n);   	


?> 

<h1><u>Задание к уроку №2.2</u><h1>
...
echo 'Общая сумма = ' . dohod(120000, 10, 10) . '<br>';
?>
<h1><u>Задание к уроку №2.3</u><h1>
